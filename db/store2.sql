...
CREATE TABLE `orders` (
  ...
  `custom_id` int(10) UNSIGNED ZEROFILL NOT NULL,
  `created_time` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(7, '漢堡蛋', 35, 1, '2023-05-13 01:48:12', '2023-05-13 01:48:12'),
(8, '雞腿堡', 40, 1, '2023-05-13 01:48:12', '2023-05-13 01:48:12'),
